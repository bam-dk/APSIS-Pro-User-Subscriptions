...
class APSIS_Pro_User_Subscriptions
{
    ...
    { ?>
        ...
        <div class="error">
            <p><?php _e('Sorry, but APSIS Pro User Subscriptions requires the APSIS Pro for WP plugin to be installed and active.', 'apsispro') ?></p>
        </div>
    ...
    public static function apsispro_us_select_default_general_render()
    {
        ...
        <select class="apsispro_us_select_default_general"
                name='apsispro_us_settings[apsispro_us_select_default_general]'>
            <?php
            $mailinglist_items = '';
            ...
            if ($mailinglists !== false) :
                foreach ($mailinglists as $index => $list_item) { ?>
                    <option
                        value="<?php echo $list_item['Id'] ?>"<?php echo ($selected_mailinglist == $list_item['Id']) ? ' selected="selected"' : ''; ?>><?php echo $list_item['Name'] ?></option>
                <?php }
            endif;
            ?>
        </select>
    ...
    public static function apsispro_us_select_default_subscriber_render()
    {
        ...
        <select class="apsispro_us_select_default_subscriber"
                name='apsispro_us_settings[apsispro_us_select_default_subscriber]'>
            <?php
            $mailinglist_items = '';
            $mailinglists = APSIS_Pro_For_WP::get_mailinglists(intval($selected_mailinglist));
            if ($mailinglists !== false) :
    ...
    public static function apsispro_us_select_role_render()
    {
        ...
        <select class="apsispro_us_select_role" name='apsispro_us_settings[apsispro_us_select_role]'>
            ...
            foreach ($roles as $role => $role_name) { ?>
                <option
                    value="<?php echo $role ?>"<?php echo ($selected_role == $role) ? ' selected="selected"' : ''; ?>><?php echo $role_name ?></option>
            <?php } ?>
        </select>
            ...
            if ($options['apsispro_hidden_verified']) :
                ...
                <div id="apsispro-us-shortcode-generator" style="display: none;">
                    ...
                    <table class="form-table">
                        ...
                        <td>
                            <input type='text' id='apsispro-us-generated-code' name='apsispro-us-generated-code'
                                   value=''
                                   readonly>
                        </td>
                    </table>
        ...
        if (!empty($mailinglist) && is_user_logged_in()) : ?>
            ...
            <div class="apsispro-user-subscription">
                <form action="?apsispro_us_action" method="post" class="apsispro-user-subscription-form">
                    <input type="hidden" name="apsispro-us-signup-name" class="apsispro-us-signup-name"
                           value="<?php echo $name; ?>"/>
                    <input type="hidden" name="apsispro-us-signup-email" class="apsispro-us-signup-email"
                    ...
                    <div class="apsispro-us-spinner"
                         style="background: url('<?php echo admin_url() ?>/images/loading.gif') no-repeat; height: 16px; width: 16px; display: none; margin-left: 6px;"></div>
                </form>
